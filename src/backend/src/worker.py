...
celery.conf.update(
    ...
    task_time_limit=os.environ.get("CELERY_TASK_TIME_LIMIT", 30 * 60),  # Default 30 minutes
    task_soft_time_limit=os.environ.get("CELERY_TASK_SOFT_TIME_LIMIT", 25 * 60),  # Default 25 minutes
